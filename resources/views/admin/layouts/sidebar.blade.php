<aside id="sidebar"
    ...
    <nav class="px-2 flex-1 overflow-y-auto">
        <div class="space-y-1">
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 {{ request()->routeIs('dashboard') ? 'bg-kemenag-light-green' : 'hover:bg-kemenag-light-green' }} p-3 rounded-lg">
            ...
            <div class="mt-4">
                ...
                <div class="dropdown-group">
                    ...
                    <div class="dropdown-content hidden pl-4 mt-1 space-y-1">
                        <a href="{{ route('categories.index') }}" class="flex items-center space-x-3 {{ request()->routeIs('categories.*') ? 'bg-kemenag-light-green' : 'hover:bg-kemenag-light-green' }} p-3 rounded-lg">
                            <i class="fas fa-list w-5"></i>
                            <span>Category</span>
                        </a>
                        <a href="{{ route('posts.index') }}" class="flex items-center space-x-3 {{ request()->routeIs('posts.*') ? 'bg-kemenag-light-green' : 'hover:bg-kemenag-light-green' }} p-3 rounded-lg">
