...
<div class="bg-white p-6 rounded-lg shadow-sm mb-8">
    ...
    <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="date" name="published_at" value="{{ old('published_at', $post->published_at ? \Carbon\Carbon::parse($post->published_at)->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <input type="text" name="tags" value="{{ old('tags', $post->tags) }}"
                        ...
                        placeholder="Contoh: berita,update,terbaru">
                    @error('tags')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    @if($post->thumbnail)
                        <img src="{{ asset('storage/'.$post->thumbnail) }}" alt="Thumbnail" class="h-16 mb-2" id="thumbnail-preview-old">
                    @endif
        ...
        <div class="mt-8 flex justify-end gap-2">
            <a href="{{ route('posts.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">Batal</a>
