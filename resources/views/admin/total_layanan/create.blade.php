    ...
    <form action="{{ route('total-layanan.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <select name="tahun" required
                class="w-full px-4 py-3 border border-kemenag-green rounded-lg focus:ring-2 focus:ring-kemenag-green focus:border-transparent transition-colors focus:outline-none @error('tahun')  @enderror">
        ...
        <div class="flex justify-end gap-2">
            <a href="{{ route('total-layanan.index') }}" class="px-4 py-2 border border-kemenag-green rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">Batal</a>
