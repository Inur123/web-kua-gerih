        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($totalLayanans as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                ...
                                <form action="{{ route('total-layanan.destroy', $item->id) }}" method="POST"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-3 text-center text-gray-500">Belum ada data total layanan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center space-x-1">
                    ...
                    <div class="sm:hidden flex items-center">
                        <span
                            class="px-3 py-1 rounded-md bg-gray-100 text-gray-700">{{ $totalLayanans->currentPage() }}</span>
