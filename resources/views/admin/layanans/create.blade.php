        ...
        <form action="{{ route('layanans.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required
                        class="w-full px-4 py-2 border border-kemenag-green focus:outline-none rounded-md focus:ring-2 focus:ring-kemenag-green focus:border-transparent">
                    @error('nama')
                ...
                <div>
                    ...
                    <select name="status" required
                        class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-kemenag-green focus:border-transparent border-kemenag-green focus:outline-none">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-kemenag-green focus:border-transparent border-kemenag-green focus:outline-none">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end gap-2 mt-8">
                ...
                <button type="submit"
                    class="px-4 py-2 rounded-md bg-kemenag-green text-white hover:bg-kemenag-light-green">Simpan</button>
            </div>
        </form>
    </div>
