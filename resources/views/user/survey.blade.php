            ...
            <div class="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm max-w-3xl mx-auto">
                <form id="satisfaction-form" action="{{ route('survey.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-kemenag-green" required placeholder="Nama Anda">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-kemenag-green" placeholder="Email Anda">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="rating-emojis flex justify-center space-x-4">
                            <input type="radio" id="emoji1" name="rating" value="1" required />
                            <label for="emoji1" title="Sangat Tidak Puas">😡</label>
                            <input type="radio" id="emoji2" name="rating" value="2" />
                            <label for="emoji2" title="Tidak Puas">😞</label>
                            <input type="radio" id="emoji3" name="rating" value="3" />
                            <label for="emoji3" title="Biasa Saja">😐</label>
                            <input type="radio" id="emoji4" name="rating" value="4" />
                            <label for="emoji4" title="Puas">😊</label>
                            <input type="radio" id="emoji5" name="rating" value="5" />
                            <label for="emoji5" title="Sangat Puas">😍</label>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="feedback" name="feedback" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-kemenag-green" placeholder="Berikan masukan dan saran untuk meningkatkan kualitas layanan kami..."></textarea>
                    </div>
