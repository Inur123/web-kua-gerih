                            ...
                            @foreach($layanan->persyaratans as $persyaratan)
                                <li>
                                    ...
                                    @if($persyaratan->link_download)
                                        - <a href="{{ $persyaratan->link_download }}" class="text-blue-500 hover:underline" target="_blank">Download</a>
                                    @endif
                            ...
                            @foreach($layanan->syaratKhusus as $syarat)
                                <li>
                                    ...
                                    @if($syarat->link_download)
                                        - <a href="{{ $syarat->link_download }}" class="text-blue-500 hover:underline" target="_blank">Download</a>
                                    @endif
                                    @if($syarat->deskripsi)
                                        <p class="text-gray-500 text-sm mt-1">{{ $syarat->deskripsi }}</p>
                                    @endif
                                </li>
                            @endforeach
                        </ul>
                            ...
                            @foreach($layanan->prosedurs as $step)
                                <li>
                                    ...
                                    @if($step->link_download)
                                        - <a href="{{ $step->link_download }}" class="text-blue-500 hover:underline" target="_blank">Download</a>
                                    @endif
                                    @if($step->deskripsi)
                                        <p class="text-gray-500 text-sm mt-1">{{ $step->deskripsi }}</p>
                                    @endif
                                </li>
                            @endforeach
                        </ol>
